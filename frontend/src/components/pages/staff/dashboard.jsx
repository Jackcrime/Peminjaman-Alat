    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          ...
          <p className="text-gray-500 mt-1">Kelola peminjaman dan pengembalian alat</p>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-400 mt-1">Alat tersedia</p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-gray-900 text-lg">Pengembalian</h3>
                <p className="text-gray-500 text-sm mt-1">Proses pengembalian alat</p>
              </div>
            </div>
          </Link>
        </div>
